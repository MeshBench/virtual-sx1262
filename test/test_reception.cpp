/* What the chip does with a signal: when a carrier counts as present, when a
 * frame is receivable and when it is simply too late, and how long a
 * transmission occupies the air.
 *
